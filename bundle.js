...
function WellnessHero({ v }) {
  ...
  return /* @__PURE__ */ React.createElement("header", { id: "top", className: "w-full bg-white" }, /* @__PURE__ */ React.createElement(
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1600px] px-6 md:px-10 lg:px-20 pt-20 md:pt-28 pb-20 md:pb-28 text-center md:text-left" }, /* @__PURE__ */ React.createElement("div", { className: "font-mono text-[11px] tracking-[0.28em] uppercase text-[var(--ink)]/55 mb-6" }, v.tag || v.audience), /* @__PURE__ */ React.createElement("h1", { className: "font-display text-[44px] md:text-[68px] lg:text-[84px] leading-[1.02] tracking-[-0.025em] text-[var(--ink)]" }, v.h1), v.sub && /* @__PURE__ */ React.createElement("p", { className: "mt-8 font-body text-[18px] md:text-[20px] leading-[1.55] text-[var(--ink)]/75 max-w-[680px] md:max-w-[760px] mx-auto md:mx-0" }, v.sub), /* @__PURE__ */ React.createElement("div", { className: "mt-12" }, /* @__PURE__ */ React.createElement("a", { href: primaryHref, className: "btn-primary" }, primaryLabel))));
}
function WellnessWhoFor({ v }) {
  const w = v.whoFor;
  if (!w) return null;
  return /* @__PURE__ */ React.createElement("section", { id: "whofor", className: "bg-[var(--warm)]" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1100px] px-6 md:px-10 lg:px-16 py-28 md:py-36" }, /* @__PURE__ */ React.createElement(window.Reveal, null, /* @__PURE__ */ React.createElement(
    "h2",
    {
    ...
    w.headline
  )), /* @__PURE__ */ React.createElement("ul", { className: "mt-14 md:mt-20 space-y-5 md:space-y-6 max-w-[760px] mx-auto" }, (w.items || []).map((line, idx) => /* @__PURE__ */ React.createElement(window.Reveal, { as: "li", key: idx, delay: idx * 50 }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start gap-4 md:gap-5 font-body text-[17px] md:text-[19px] leading-[1.55] text-[var(--ink)]/90" }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "mt-[3px] text-[var(--green)] text-[18px] md:text-[20px]" }, "\u2713"), /* @__PURE__ */ React.createElement("span", null, line))))), w.footnote && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 200 }, /* @__PURE__ */ React.createElement("p", { className: "mt-14 md:mt-20 pt-8 md:pt-10 border-t border-[var(--ink)]/15 font-body italic text-[15px] md:text-[16px] leading-[1.65] text-[var(--ink)]/65 max-w-[820px] mx-auto text-center" }, w.footnote))));
}
function WellnessPrinciples({ v }) {
  const p = v.principles;
  if (!p) return null;
  const items = p.items || [];
  return /* @__PURE__ */ React.createElement("section", { className: "bg-white" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1600px] px-6 md:px-10 lg:px-20 py-28 md:py-36" }, /* @__PURE__ */ React.createElement(window.Reveal, null, /* @__PURE__ */ React.createElement(
    "h2",
    {
    ...
    p.headline
  )), p.image !== void 0 && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 80 }, /* @__PURE__ */ React.createElement("div", { className: "mt-14 md:mt-20" }, /* @__PURE__ */ React.createElement(
    window.PhotoPlaceholder,
    {
  ...
  ))), p.body && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 160 }, /* @__PURE__ */ React.createElement("p", { className: "mt-14 md:mt-20 font-body text-[18px] md:text-[20px] leading-[1.7] text-[var(--ink)]/85 max-w-[820px] mx-auto text-center" }, p.body)), items.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "mt-14 md:mt-20 grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6" }, items.map((it, idx) => /* @__PURE__ */ React.createElement(window.Reveal, { key: it.title, delay: idx * 60 }, /* @__PURE__ */ React.createElement("article", { className: "vessel-card h-full text-center" }, /* @__PURE__ */ React.createElement("h3", { className: "font-display text-[22px] md:text-[24px] tracking-[-0.015em] text-[var(--green)] leading-[1.25]" }, it.title), it.body && /* @__PURE__ */ React.createElement("p", { className: "mt-3 font-body text-[14.5px] leading-[1.65] text-[var(--ink)]/85" }, it.body)))))));
}
function WellnessConcept({ v }) {
  const pillars = v.pillars || [];
  const pb = v.pillarsBlock || {};
  return /* @__PURE__ */ React.createElement("section", { id: "pillars", className: "bg-[var(--warm)]" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1600px] px-6 md:px-10 lg:px-20 py-28 md:py-36" }, /* @__PURE__ */ React.createElement(window.Reveal, null, /* @__PURE__ */ React.createElement(
    "h2",
    {
      className: "font-display text-[34px] md:text-[48px] lg:text-[56px] leading-[1.1] tracking-[-0.02em] text-[var(--ink)] text-center",
      style: { textWrap: "balance" }
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "mt-14 md:mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8" }, pillars.map((p, i) => /* @__PURE__ */ React.createElement(window.Reveal, { key: p.title, delay: i * 60 }, /* @__PURE__ */ React.createElement("article", { className: "vessel-card h-full flex flex-col" }, /* @__PURE__ */ React.createElement("h3", { className: "font-display text-[30px] md:text-[36px] tracking-[-0.02em] text-[var(--green)] leading-[1.15]" }, p.title), p.cadence && /* @__PURE__ */ React.createElement("div", { className: "mt-2 font-body italic text-[15px] md:text-[16px] leading-[1.5] text-[var(--ink)]/65" }, p.cadence), /* @__PURE__ */ React.createElement("ul", { className: "mt-7 border-t border-[var(--ink)]/15 flex-1" }, (p.items || []).map((l) => /* @__PURE__ */ React.createElement(
    "li",
    {
      key: l,
      className: "border-b border-[var(--ink)]/15 py-3 flex items-center gap-3 font-body text-[14.5px] text-[var(--ink)]/85"
    },
    /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "text-[var(--green)] text-[14px]" }, "\u2022"),
...
function WellnessProgram({ v }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { id: "programme", className: "bg-white" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1600px] px-6 md:px-10 lg:px-20 py-28 md:py-36" }, /* @__PURE__ */ React.createElement(window.Reveal, null, /* @__PURE__ */ React.createElement(
    "h2",
    {
      className: "font-display text-[34px] md:text-[48px] lg:text-[56px] leading-[1.1] tracking-[-0.02em] text-[var(--ink)] text-center",
      style: { textWrap: "balance" }
    ...
    pr.headline
  )), /* @__PURE__ */ React.createElement("div", { className: "mt-14 md:mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8" }, columns.map((c, idx) => /* @__PURE__ */ React.createElement(window.Reveal, { key: c.title, delay: idx * 60 }, /* @__PURE__ */ React.createElement("article", { className: "vessel-card h-full flex flex-col" }, /* @__PURE__ */ React.createElement("h3", { className: "font-display text-[26px] md:text-[30px] tracking-[-0.015em] text-[var(--green)] leading-[1.2]" }, c.title), /* @__PURE__ */ React.createElement("ul", { className: "mt-7 border-t border-[var(--ink)]/15 flex-1" }, (c.items || []).map((l) => /* @__PURE__ */ React.createElement(
    "li",
    {
      key: l,
      className: "border-b border-[var(--ink)]/15 py-3 flex items-center gap-3 font-body text-[14.5px] text-[var(--ink)]/85"
    ...
    /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "text-[var(--green)] text-[14px]" }, "\u2022"),
    /* @__PURE__ */ React.createElement("span", null, l)
  ))))))), pr.footnote && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 200 }, /* @__PURE__ */ React.createElement("p", { className: "mt-12 md:mt-16 font-body italic text-[15px] md:text-[16px] leading-[1.65] text-[var(--ink)]/65 max-w-[860px] mx-auto text-center" }, pr.footnote))));
}
function WellnessDay8({ v }) {
  const d = v.day8;
  if (!d) return null;
  return /* @__PURE__ */ React.createElement("section", { className: "bg-[var(--warm)]" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1200px] px-6 md:px-10 lg:px-16 py-28 md:py-36" }, /* @__PURE__ */ React.createElement(window.Reveal, null, /* @__PURE__ */ React.createElement(
    "h2",
    {
      className: "font-display text-[34px] md:text-[48px] lg:text-[56px] leading-[1.1] tracking-[-0.02em] text-[var(--ink)] text-center",
      style: { textWrap: "balance" }
    ...
    d.headline
  )), /* @__PURE__ */ React.createElement(window.Reveal, { delay: 80 }, /* @__PURE__ */ React.createElement("div", { className: "mt-14 md:mt-20" }, /* @__PURE__ */ React.createElement(
    window.PhotoPlaceholder,
    {
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "mt-14 md:mt-20 max-w-[720px] mx-auto text-center space-y-6" }, d.body1 && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 160 }, /* @__PURE__ */ React.createElement("p", { className: "font-body text-[18px] md:text-[20px] leading-[1.7] text-[var(--ink)]/85" }, d.body1)), d.body2 && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 220 }, /* @__PURE__ */ React.createElement("p", { className: "font-body text-[18px] md:text-[20px] leading-[1.7] text-[var(--ink)]/85" }, d.body2)))));
}
function WellnessPlace({ v }) {
  const p = v.place;
  if (!p) return null;
  const extras = p.extraImages || [];
  return /* @__PURE__ */ React.createElement("section", { id: "place", className: "bg-white" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1600px] px-6 md:px-10 lg:px-20 py-28 md:py-36" }, /* @__PURE__ */ React.createElement(window.Reveal, null, /* @__PURE__ */ React.createElement(
    "h2",
    {
      className: "font-display text-[34px] md:text-[48px] lg:text-[56px] leading-[1.1] tracking-[-0.02em] text-[var(--ink)] text-center",
      style: { textWrap: "balance" }
    ...
    p.headline
  )), p.mainImage !== void 0 && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 80 }, /* @__PURE__ */ React.createElement("div", { className: "mt-14 md:mt-20" }, /* @__PURE__ */ React.createElement(
    window.PhotoPlaceholder,
    {
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "mt-14 md:mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 max-w-[1100px] mx-auto" }, /* @__PURE__ */ React.createElement(window.Reveal, { delay: 120 }, /* @__PURE__ */ React.createElement("div", null, p.subhead && /* @__PURE__ */ React.createElement("div", { className: "font-mono text-[11px] tracking-[0.28em] uppercase text-[var(--green)] mb-5" }, p.subhead), p.body && /* @__PURE__ */ React.createElement("p", { className: "font-display text-[22px] md:text-[26px] leading-[1.35] tracking-[-0.015em] text-[var(--ink)]" }, p.body))), /* @__PURE__ */ React.createElement(window.Reveal, { delay: 180 }, /* @__PURE__ */ React.createElement("ul", { className: "space-y-3" }, (p.bullets || []).map((line) => /* @__PURE__ */ React.createElement(
    "li",
    {
      key: line,
      className: "flex items-start gap-3 font-body text-[15.5px] md:text-[16.5px] leading-[1.55] text-[var(--ink)]/85"
    },
    /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "mt-[7px] block w-[6px] h-[6px] rounded-full bg-[var(--green)]" }),
    /* @__PURE__ */ React.createElement("span", null, line)
  ))))), p.nearby && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 240 }, /* @__PURE__ */ React.createElement("p", { className: "mt-12 md:mt-16 font-body italic text-[15px] md:text-[16px] leading-[1.65] text-[var(--ink)]/65 max-w-[1100px] mx-auto text-center" }, p.nearby)), extras.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "mt-14 md:mt-20 grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6" }, extras.map((img, idx) => /* @__PURE__ */ React.createElement(window.Reveal, { key: img.cap + idx, delay: idx * 60 }, /* @__PURE__ */ React.createElement(
    window.PhotoPlaceholder,
    {
      palette: img.palette,
      caption: img.cap,
...
function WellnessInvestment({ v }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { id: "investment", className: "bg-[var(--warm)]" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1000px] px-6 md:px-10 lg:px-16 py-28 md:py-36" }, /* @__PURE__ */ React.createElement(window.Reveal, null, /* @__PURE__ */ React.createElement(
    "h2",
    {
      className: "font-display text-[34px] md:text-[48px] lg:text-[56px] leading-[1.1] tracking-[-0.02em] text-[var(--ink)] text-center",
      style: { textWrap: "balance" }
    ...
    inv.headline
  )), inv.intro && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 80 }, /* @__PURE__ */ React.createElement("p", { className: "mt-8 font-body text-[16px] md:text-[17px] leading-[1.65] text-[var(--ink)]/80 max-w-[720px] mx-auto text-center" }, inv.intro)), /* @__PURE__ */ React.createElement(window.Reveal, { delay: 140 }, /* @__PURE__ */ React.createElement("div", { className: "mt-14 md:mt-16 vessel-card bg-white !p-12 md:!p-16 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "font-display text-[56px] md:text-[80px] leading-[1.02] tracking-[-0.03em] text-[var(--green)]" }, inv.price), /* @__PURE__ */ React.createElement("div", { className: "mt-3 font-body text-[15px] md:text-[17px] text-[var(--ink)]/70" }, inv.priceUnit))), inv.ctaLabel && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 200 }, /* @__PURE__ */ React.createElement("div", { className: "mt-10 md:mt-12 text-center" }, /* @__PURE__ */ React.createElement("a", { href: MAILTO, className: "btn-primary" }, inv.ctaLabel))), inv.note && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 260 }, /* @__PURE__ */ React.createElement("p", { className: "mt-8 font-body italic text-[14.5px] md:text-[15px] leading-[1.55] text-[var(--ink)]/60 text-center max-w-[600px] mx-auto" }, inv.note))));
}
function WellnessFAQ({ v }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { id: "faq", className: "bg-white" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1100px] px-6 md:px-10 lg:px-16 py-28 md:py-36" }, /* @__PURE__ */ React.createElement(window.Reveal, null, /* @__PURE__ */ React.createElement(
    "h2",
    {
      className: "font-display text-[34px] md:text-[48px] lg:text-[56px] leading-[1.1] tracking-[-0.02em] text-[var(--ink)] text-center",
      style: { textWrap: "balance" }
  ...
  )), /* @__PURE__ */ React.createElement("ul", { className: "mt-14 md:mt-20 border-t border-[var(--ink)]/15" }, items.map((it, i) => {
    ...
    return /* @__PURE__ */ React.createElement("li", { key: it.q, className: "border-b border-[var(--ink)]/15" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: "font-display text-[20px] md:text-[24px] tracking-[-0.015em] text-[var(--ink)] leading-[1.3]" }, it.q),
      /* @__PURE__ */ React.createElement(
        "span",
        {
          "aria-hidden": "true",
      ...
      /* @__PURE__ */ React.createElement("p", { className: "pb-7 md:pb-8 font-body text-[15px] md:text-[16px] leading-[1.65] text-[var(--ink)]/80 max-w-[720px]" }, it.a)
    ));
  }))));
}
function WellnessClosing({ v }) {
  const c = v.closing;
  if (!c) return null;
  return /* @__PURE__ */ React.createElement("section", { className: "bg-[var(--ink)] text-[var(--warm)]" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1100px] px-6 md:px-10 lg:px-16 py-28 md:py-36 text-center" }, /* @__PURE__ */ React.createElement(window.Reveal, null, /* @__PURE__ */ React.createElement(
    "h2",
    {
    ...
    c.line
  )), c.sub && /* @__PURE__ */ React.createElement(window.Reveal, { delay: 80 }, /* @__PURE__ */ React.createElement("p", { className: "mt-8 font-body text-[17px] md:text-[19px] leading-[1.6] text-[var(--warm)]/80 max-w-[680px] mx-auto" }, c.sub)), /* @__PURE__ */ React.createElement(window.Reveal, { delay: 160 }, /* @__PURE__ */ React.createElement("div", { className: "mt-12" }, /* @__PURE__ */ React.createElement("a", { href: MAILTO, className: "btn-primary-on-dark" }, c.buttonLabel || "Book the retreat")))));
}
function WellnessFooter({ v }) {
  const f = v.footer;
  if (!f) return /* @__PURE__ */ React.createElement(window.Footer, null);
  return /* @__PURE__ */ React.createElement("footer", { className: "bg-[var(--ink)] text-[var(--warm)] border-t border-white/10" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-[1600px] px-6 md:px-10 lg:px-20 py-16" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex items-baseline gap-3" }, /* @__PURE__ */ React.createElement("span", { className: "font-display text-[28px] tracking-tight" }, f.brand || "Parents Vitality")), f.tagline && /* @__PURE__ */ React.createElement("p", { className: "mt-3 font-mono text-[10px] uppercase tracking-[0.22em] opacity-70 max-w-[420px]" }, f.tagline)), /* @__PURE__ */ React.createElement("div", { className: "font-mono text-[12px] tracking-[0.05em] uppercase opacity-85 space-y-2" }, f.email && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("a", { href: `mailto:${f.email}`, className: "underline underline-offset-4 decoration-white/30 hover:decoration-white" }, f.email)), f.phone && /* @__PURE__ */ React.createElement("div", null, f.phone), f.socials && f.socials.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "pt-2 flex flex-wrap gap-x-6 gap-y-2" }, f.socials.map((s) => /* @__PURE__ */ React.createElement("a", { key: s.label, href: s.href, className: "opacity-75 hover:opacity-100" }, s.label))))), /* @__PURE__ */ React.createElement("div", { className: "mt-14 pt-8 border-t border-white/10 flex flex-wrap items-center justify-between gap-4 font-mono text-[10px] uppercase tracking-[0.22em] opacity-55" }, /* @__PURE__ */ React.createElement("span", null, "\xA9 2026 ", f.brand || "Parents Vitality Retreat"), f.legalLinks && f.legalLinks.length > 0 && /* @__PURE__ */ React.createElement("ul", { className: "flex flex-wrap items-center gap-x-8 gap-y-2" }, f.legalLinks.map((l) => /* @__PURE__ */ React.createElement("li", { key: l.label }, /* @__PURE__ */ React.createElement("a", { href: l.href, className: "opacity-75 hover:opacity-100" }, l.label)))))));
}
function WellnessPremise() {
  return null;
}
